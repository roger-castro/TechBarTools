...
$FilePath = "$DriveLetter\Completed Driver Checks\$SerialNumber-DriverVersion_4_After_AutoPilot.csv"
...
echo ""
Write-Host "Report $SerialNumber-DriverVersion_4_After_AutoPilot.csv created successfully"
echo ""
