...
$FilePath = "$DriveLetter\Completed Driver Checks\$SerialNumber-DriverVersion_3_After_FreshStart_After_Updates.csv"
...
echo ""
Write-Host "Report $SerialNumber-DriverVersion_3_After_FreshStart_After_Updates.csv created successfully"
echo ""
