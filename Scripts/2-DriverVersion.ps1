...
$FilePath = "$DriveLetter\Completed Driver Checks\$SerialNumber-DriverVersion_2_After_FreshStart_Before_Updates.csv"
...
echo ""
Write-Host "Report $SerialNumber-DriverVersion_2_After_FreshStart_Before_Updates.csv created successfully"
echo ""
